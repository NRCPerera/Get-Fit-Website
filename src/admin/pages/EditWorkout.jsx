...
import { ArrowLeft, Save, Plus, X, Dumbbell, GripVertical, Loader2, Search } from 'lucide-react';
...
const EditWorkout = () => {
    ...
    const fetchWorkout = async () => {
        try {
            const res = await workoutAPI.getWorkoutById(id);
            ...
            setFormData({
                ...
                scheduleType: workout.scheduleType || '1-day',
                goals: workout.goals || [],
                exercises: workout.exercises || [],
                isActive: workout.isActive !== undefined ? workout.isActive : true
            });
        } catch (error) {
            console.error(error);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await workoutAPI.updateWorkout(id, formData);
            navigate('/admin/workouts');
        } catch (error) {
            console.error(error);
        ...
        <div className="page-container" style={{ maxWidth: '64rem' }}>
            <div className="page-header">
                ...
                <div className="page-title">
                    ...
                    <p>Update the workout program details</p>
                </div>
            </div>
